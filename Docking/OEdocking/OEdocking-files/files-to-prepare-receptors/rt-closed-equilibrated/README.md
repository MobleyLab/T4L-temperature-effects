Here you can find the files used to initialize the receptor for docking in the equilibrated RT structure of T4-L99A with a closed loop conformation after 50 ns of MD simulations:
